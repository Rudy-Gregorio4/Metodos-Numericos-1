...
# Definir las matrices A y B para el ejercicio 3
A = np.array([[1, 0.22], [4, 1]])
B = np.array([[3, 5], [-2, 2]])
...
print("\nInciso 3.1: Normas de las matrices A y B")
...
print("\nInciso 3.4: Condición de las matrices A y B")
